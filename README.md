...
██║  ██║██║  ██║██║  ██╗██║██║  ██╗██║
╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚═╝  ╚═╝╚═╝
  pentest field notebook · command-first · phase-oriented
```

![stack](https://img.shields.io/badge/stack-Kali%20%2F%20Linux-557C94?logo=linux&logoColor=white)
![format](https://img.shields.io/badge/format-quick%20reference-1BB91F)
![scope](https://img.shields.io/badge/scope-authorized%20use%20only-E03C31)
